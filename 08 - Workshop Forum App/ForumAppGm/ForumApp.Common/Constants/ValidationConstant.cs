namespace ForumApp.Common.Constants
{
    public static class ValidationConstant
    {
        ...
        //errors
        public const string ErrorMessageTitleLength = "The {0} length is between {3} and {2}";
        public const string ErrorMessageContextLength = "The {0} length is between {3} and {2}";
