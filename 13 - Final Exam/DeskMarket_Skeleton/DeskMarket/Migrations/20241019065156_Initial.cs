        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "Name")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "SellerId"),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "AddedOn"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "CategoryId"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "IsDeleted")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "ClientId")
                },
                constraints: table =>
                {
